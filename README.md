...
- `Loader`: defaults to `api.LoaderCSS`,
  you can pass a function which will be given the path of the file being processed so you can pick another loader instead, e.g. `api.LoaderLocalCSS` if dealing with CSS modules.
